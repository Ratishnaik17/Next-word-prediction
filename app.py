...
@st.cache_resource
def load_resources():
    model = load_model("C:\\Users\\naikr\\OneDrive\\Desktop\\Next_word_pred\\lstm_model.h5")
    with open("C:\\Users\\naikr\\OneDrive\\Desktop\\Next_word_pred\\tokenizer.pkl", "rb") as f:
        tokenizer = pickle.load(f)
    with open("C:\\Users\\naikr\\OneDrive\\Desktop\\Next_word_pred\\max_len.pkl", "rb") as f:
